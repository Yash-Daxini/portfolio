...
export const PROJECTS: Project[] = [
  {
    ...
    description:
      "Designed and delivered production-grade features for a scalable POS system supporting multiple tenants, focusing on performance, reliability, and seamless data flow.",
    tech: [
      "Angular",
      ".NET",
      "Microservices",
  ...
  },
  {
    ...
    description:
      "Developed HomeSeer plugins enabling integration of smart locks, sensors, Wi-Fi bulbs, and gateways, ensuring fault-tolerant automation and reliable device communication.",
    tech: ["React", "C#", ".NET", "Javascript", "Jquery", "Sqlite"],
  },
  {
    title: "Online Ordering Web Platform",
    description:
      "Built responsive and accessible user interfaces for an online ordering system, enhancing customer experience through intuitive design and optimized frontend performance.",
    tech: [
      "Angular",
      "Typescript",
      ".NET",
  ...
  },
  {
    ...
    description:
      "Contributed to a high-performance trading platform by leading frontend development and optimizing backend data processing using caching techniques.",
    tech: ["React", ".NET", "MySQL", "Redis", "Docker", "Node JS"],
  },
  {
    title: "CI/CD & Deployment Automation",
    description:
      "Created and maintained automated build and deployment pipelines using TeamCity, improving release consistency, reducing manual effort, and supporting QA and staging environments.",
  ...
  },
  {
    ...
    description:
      "Built a Microsoft Outlook–inspired calendar application featuring recurring events and optimized overlap-detection algorithms, ensuring reliable scheduling and strong performance even with large event datasets.",
    tech: ["React", ".NET", "MSSQL"],
    githubLink:
      "https://github.com/Yash-Daxini/Customizable-Event-Calendar-Backend",
  },
  {
    title: "Distributed Rate Limiter",
    description:
      "Designed and implemented a high-performance distributed rate limiter to control API traffic across multiple servers, using atomic Redis operations and concurrency-safe algorithms for accuracy under heavy load.",
  ...
  },
  {
    ...
    description:
      "Developed a scalable comment system supporting posts, nested replies, and upvote/downvote functionality, focusing on responsive UI design and efficient backend data handling.",
...
export const SKILLS = {
  devops: {
    ...
    items: [
      "CI/CD Concepts",
      "TeamCity (Build & Deployment Pipelines)",
      "Docker",
